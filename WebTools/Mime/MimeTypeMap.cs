...
public static class MimeTypeMap
{
    ...
    private static IDictionary<string, string> BuildMappings()
    {
        ...
        mappings
            .ToList()
            .ForEach(x => mappings.TryAdd(x.Value, x.Key));
    ...
    public static bool TryGetMimeType(string? ext, [MaybeNullWhen(false)] out string mimeType)
    {
        ...
        return Mappings.Value.TryGetValue(ext, out mimeType);
    }
    ...
    public static string? GetExtension(string mimeType)
    {
        ...
        return Mappings.Value.TryGetValue(mimeType, out string? extension)
            ? extension
            : null;
    }
